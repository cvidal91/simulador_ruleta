...
Para poder desplegar el aplicativo se deben seguir los pasos descritos a continuación:
- Clonar el proyecto
...
- Seleccionar la base de datos creada y ejecutar en POSTGRESQL el script SQL 20200225_script.sql que se encuentra en la carpeta scripts/ (Esto crea las tablas de base de datos)
